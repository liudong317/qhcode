...
> 文档更新日期：2026-09-10（**当前发版 v1.0.1**；今晚计划打 Mac M）
...
| 优先级 | 目标 | 状态 |
|--------|------|------|
| P0 | Windows 桌面 App（exe），双击可用 | **已出 v1.0.1** |
...
- [x] **v1.0.1 安装包**（保留；已删 v1.0.0）：`QhCode-1.0.1-win-x64.exe` ≈ **204MB**
  - 本机：`E:\文件\QhCode-1.0.1-win-x64.exe`
  - 工程：`C:\dev\open-cowork\release\QhCode-1.0.1-win-x64.exe`
  - 下载：https://github.com/liudong317/qhcode/releases/tag/v1.0.1
- [x] v1.0.1：任务栏狐狸图标（打包 `icon.ico` + `AppUserModelId=com.qinghong.qhcode`）
- [x] 飞书用户说明：`E:\文件\QhCode-飞书文档.md`（可整篇粘贴飞书）
...
| Gitee / GitHub | 见第七节 |
| 当前 Win Release | https://github.com/liudong317/qhcode/releases/tag/v1.0.1 |
...
3. **M2.1（完成）**：v1.0.1 Base URL 可改 + 狐狸任务栏图标  
...
| 资讯 / 行情 API | 见第三节 |
| QhCode 下载（Win） | [Releases v1.0.1](https://github.com/liudong317/qhcode/releases/tag/v1.0.1) |
