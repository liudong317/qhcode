...
const servers = [
  ...
  {
    name: 'qinghong-finance-server',
    entry: 'qinghong-finance-server.ts',
    description: 'Qinghong Finance MCP Server',
  },
  {
    name: 'qinghong-market-server',
    entry: 'qinghong-market-server.ts',
    description: 'Qinghong Market MCP Server',
  },
];
